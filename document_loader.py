...
class DocumentDatabase:
    ...
    def _load_documents(self):
        if os.path.isdir(self.path):
            ...
            loader = DirectoryLoader(self.path, glob=f"./*{self.filetype}", loader_cls=PyPDFLoader)
        else:
    ...
    def _embed_documents(self, documents):
        ...
        Chroma.from_documents(documents=texts, embedding=embedding_function, persist_directory='db')
